...
python3 train.py --token_vocab ${dataset}/token_vocab\
    ...
    --train_data ${dataset}/train.txt.features.preproc2.json\
    --train_forests $SCR2/k-decomp/${DTAG}/train_forests${SUF}.hdf5\
    --train_sep2frags $SCR2/k-decomp/${DTAG}/train_sep2frags${SUF}.pkl\
    --dev_data ${dataset}/dev.txt.features.preproc2.json\
    --dev_forests $SCR2/k-decomp/${DTAG}/dev_forests${SUF}.hdf5\
    --dev_sep2frags $SCR2/k-decomp/${DTAG}/dev_sep2frags${SUF}.pkl\
