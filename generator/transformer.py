...
class MultiheadAttention(jit.ScriptModule):
    ...
    @jit.script_method
    def forward(self, query, key, value, key_padding_mask=None, attn_mask=None, fine_attn_mask=None, need_weights=False, qkv_same=False, kv_same=False):
        # type: (Tensor, Tensor, Tensor, Optional[Tensor], Optional[Tensor], Optional[Tensor], bool, bool, bool) -> Tuple[Tensor, Tensor]
