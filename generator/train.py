...
def main(args, local_rank):
    ...
    train_data = DataLoader(vocabs, lexical_mapping, args.train_data, args.train_forests, args.train_sep2frags, args.train_batch_size, for_train=True)
    dev_data = DataLoader(vocabs, lexical_mapping, args.dev_data, args.dev_forests, args.dev_sep2frags, args.dev_batch_size, for_train=False)
            ...
            for batch in train_data:
                ...
                if args.world_size == 1 or (dist.get_rank() == 0):
                    ...
                    if batches_acm > args.warmup_steps and batches_acm %\
                        ...
                        bleu, chrf = validate(model, dev_data, golden_file)
